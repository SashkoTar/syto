...
object DigitalButterworthBandPassFilter {
  ...
  def apply(order: Int, lowCutoffFrequency: Float, highCutoffFrequency: Float, sampleFrequency: Float): DigitalButterworthBandPassFilter =
    new DigitalButterworthBandPassFilter(order, lowCutoffFrequency, highCutoffFrequency, sampleFrequency)

}

class DigitalButterworthBandPassFilter(order: Int, lowCutoffFrequency: Float, highCutoffFrequency: Float, sampleFrequency: Float)
