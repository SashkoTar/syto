package net.sparja.syto.filter.elliptic.digital
...
class BandStopFilterTest {
  ...
  def calculateCoefficients(order: Int, ripplePass: Double, rippleStop: Double, lowFreq: Double, highFreq: Double, sampleFreq: Double) = {
